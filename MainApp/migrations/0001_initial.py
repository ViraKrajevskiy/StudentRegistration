    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.FileField(upload_to='applicants_photos/', verbose_name='Rasm')),
                ...
                ('choice_field', models.CharField(choices=[('Ona', 'Onam'), ('Ota', 'Otam'), ('Boshqa', 'Boshqa')], max_length=10, verbose_name="Kim orqali bog'lanish")),
        ...
        migrations.AddField(
            ...
            name='faculty',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='directions', to='MainApp.faculty', verbose_name='Fakultet'),
        ),
    ]
